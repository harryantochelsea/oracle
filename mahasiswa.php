			...
			<form class="form-horizontal" action="tambah.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID</label>
				  <input type="text" class="form-control" name="id" placeholder="Id Mahasiswa">
				</div>
				<div class="form-group col-md-6">
			  ...
			  <div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="jurusan" placeholder="Jurusan Mahasiswa">
				</div>
				<div class="form-group col-md-6">
				  <label for="">HP</label>
			   ...
			   <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="biaya" placeholder="Biaya Daftar">
				</div>
			  </div>																													
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
						include 'koneksi.php';
						$stid = oci_parse($conn, 'SELECT * from mhs');
						oci_execute($stid);
                        ...
                        <tr>
                          ...
                          <td class="td-actions">
						  <a href="mahasiswa_update.php?id=<?= $d['ID'] ?>">
