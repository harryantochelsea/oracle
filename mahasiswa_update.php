          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($conn,"SELECT * FROM mhs WHERE ID = '$id'");
				  oci_execute($stid);
			...
			<form class="form-horizontal" action="proses_update.php" method="post">
			 ...
			 <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="jk" value="<?= $d['JK'] ?>">
				</div>
			<div class="form-group col-md-6">
			...
			<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="biaya" value="<?= $d['BIAYA'] ?>">
				</div>
